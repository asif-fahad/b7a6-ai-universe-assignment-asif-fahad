...
const loadMyAI = async () => {
  ...
  sortCard = data.data.tools;
  sortCardsByDate(); // Sort cards initially by date
  showAllCards(sortCard.slice(0, 6));
};

loadMyAI();

const showAllCards = (cards, numCards = cards.length) => {
    toggleSpinner(true)
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 d-flex justify-content-center">
                ...
                <div class="col">
                  <div class="card">
                    ...
                    ${modalDetail?.accuracy.score
                      ? `<button id="accuracy-btn" class="fs-6 fw-light text-white bg-danger position-absolute top-0 end-0 border-0">${modalDetail?.accuracy.score * 100}% accuracy</button>`
                      : ''}
...
document.getElementById('sort-by-date').addEventListener('click', toggleSortOrder);
...
// // const sortByDate = () => {
// //   const sorting = sortCard.sort((a, b) => new Date(a.published_in) - new Date(b.published_in));
// //   // console.log(cards)
// //   showAllCards(sorting);
// // }

// document.getElementById('sort-by-date').addEventListener('click', function () {
//   sortCard.sort((a, b) => new Date(a.published_in) - new Date(b.published_in));
//   // console.log(cards)
//   showAllCards(sortCard);
// })
